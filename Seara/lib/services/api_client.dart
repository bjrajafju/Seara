...
class ApiClient {
  static Future<Map<String, String>> _attachAuth(Map<String, String>? customHeaders) async {
    final token = await AuthService.getToken();
    final modified = customHeaders != null ? Map<String, String>.from(customHeaders) : <String, String>{};
    if (token != null) {
  ...
  static Future<Map<String, String>> attachAuthHeaders(Map<String, String>? customHeaders) async {
